CREATE TABLE IF NOT EXISTS banner (banner_id SERIAL PRIMARY KEY, banner_name TEXT UNIQUE, banner_url TEXT, banner_imgsrc TEXT, banner_startdate INT,banner_enddate INT, banner_maxtier TEXT, banner_mintier TEXT,banner_minbalance INT,banner_maxbalance INT,banner_mintokopoint INT,banner_maxtokopoint INT,banner_isactive INT);
...
CREATE TABLE IF NOT EXISTS users (user_id SERIAL PRIMARY KEY, user_name TEXT, user_email TEXT UNIQUE, user_balance INT, user_tokopoint INT, user_tier TEXT, user_location TEXT, user_bannerlist TEXT);
